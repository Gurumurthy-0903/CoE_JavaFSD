...
class LibraryManager extends LibrarySystem {
    ...
    public synchronized void borrowBook(String ISBN, String userID) throws BookNotFoundException, UserNotFoundException {
        ...
        if (book == null) throw new BookNotFoundException("Book not found or already borrowed.");
    ...
    public synchronized void returnBook(String ISBN, String userID) throws BookNotFoundException, UserNotFoundException {
        ...
        if (book == null) throw new BookNotFoundException("Book not found in the user's borrowed books.");
...
public class LibraryManagement {
    public static void main(String[] args) {
        ...
        library.addUser(new User("JAKE", "PEC1"));
        library.addUser(new User("ADAM", "PEC2"));

        Thread t1 = new Thread(() -> {
            try { 
                library.borrowBook("12345", "PEC1"); 
            } catch (Exception e) { 
